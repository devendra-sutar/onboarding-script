...
deploy_trivy() {
    ...
    helm --kubeconfig="$KUBECONFIG" upgrade --install trivy-operator aquasecurity/trivy-operator -n kubesage-security -f https://github.com/devendra-sutar/onboarding-script/blob/master/trivy-values.yaml > /dev/null 2>&1 || true
